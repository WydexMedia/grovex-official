...
export default function Dashboard() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined" && localStorage.getItem("Grovex_logged_in") !== "true") {
      router.push("/login");
    }
  }, [router]);

  console.log("Data isssss", submissions)
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div className="flex flex-col sm:flex-row gap-2 items-center">
              ...
              <button
                ...
                onClick={() => {
                  localStorage.removeItem("Grovex_logged_in");
                  router.push("/login");
                }}
              >
                Logout
          ...
          <div className="flex items-center">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                ...
                >
                  {examTypeFilter === 'all' && 'Digital Marketing '}
                  <svg className="ml-2 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                  </svg>
                </ShadcnButton>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <ShadcnButton
                        variant="outline"
                        className="bg-black border-gray-600  hover:bg-gray-800 min-w-16 text-sm justify-between"
                      >
                        {itemsPerPage}
                        <svg className="ml-2 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
